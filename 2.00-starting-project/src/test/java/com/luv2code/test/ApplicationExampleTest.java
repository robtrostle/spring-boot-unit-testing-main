...
@SpringBootTest(classes = MvcTestingExampleApplication.class)
 class ApplicationExampleTest {
    ...
    public void beforeEach(){
        ...
        student.setFirstname("Dada");
        student.setLastname("Trostle");
        student.setEmailAddress("ddt@gmail.com");
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setFirstname("Nick");
        studentTwo.setLastname("Trostle");
        studentTwo.setEmailAddress("Nick.Trostle@yahoo.com");
