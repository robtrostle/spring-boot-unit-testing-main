...
public class GradebookControllerTest {
    ...
    @Autowired
    private StudentDao studentDao;//gives us access to the DB
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent studentOne =
                new CollegeStudent("Eric", "Roby", "eric_roby@luv2code_school.com");
    ...
    public void deleteStudentHttpRequest() throws Exception {
        assertTrue(studentDao.findById(1).isPresent());//this is done in before each
    ...
    @Test
    public void createAValidGradeStudentDoesNotExist() throws Exception {
    ...
    @Test
    public void createNonValidGradeGradeTypeDoesNotExist() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade", "85.00")
                .param("gradeType", "airguitar")
                .param("studentId", "1")).andExpect(status().isOk()).andReturn();
    ...
    @Test
    public void deleteAValidGradeStudentDoesNotExist () throws Exception {
    ...
    @Test
    public void deleteANonValidGrade() throws Exception {
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders
                        .get("/grades/{id}/{gradeType", 1,"bubblemaking"))
                .andExpect(status().isOk()).andReturn();
